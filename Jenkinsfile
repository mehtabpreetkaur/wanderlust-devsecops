pipeline {
    ...
    stages {
        stage("Checkout Stage") {
            steps {
                script {
                    git branch: 'gcp-devsecops', url: 'https://github.com/mehtabpreetkaur/wanderlust-devsecops.git'
                }
            }
        }
        ...
        stage("Deploy to GKE Cluster") {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'gke_devsecops-3-tier-458810_us-central1_wanderlust-devsecops', contextName: 'gke_devsecops-3-tier-458810_us-central1_wanderlust-devsecops', credentialsId: 'k8s-secret', namespace: 'devsecops', restrictKubeConfigAccess: false, serverUrl: 'https://34.135.35.175') {
                    script {
